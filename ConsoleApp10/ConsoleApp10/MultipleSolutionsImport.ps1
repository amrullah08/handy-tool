...
#
param(
[string]$solutionListFile, #The absolute path to the Solution.txt file zip to be imported
[string]$solutionImportPath, #The absolute path to the current directory
...
Write-Verbose "solutionFile = $solutionListFile"
